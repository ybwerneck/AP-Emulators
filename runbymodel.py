# -*- coding: utf-8 -*-
"""
Created on Tue Nov  8 20:26:28 2022
...
tmodelpe=1 ##utils.measureModelPerfomance(dist,partial(model.run,use_gpu=False, regen=True,name="out.txt"))

Ns,Nv=int(1e3),int(1e4)
